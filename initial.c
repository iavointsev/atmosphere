...
static void generate_inital_fname(char *buffer, size_t size, ProblemConfig config);
...
static complex_t *generate_wave(size_t NX, size_t NY, double LX, double LY, double w_0,
								WaveProfile profile)
{
